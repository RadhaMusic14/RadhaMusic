...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("RADHAMUSIC/assets/thumb/font2.ttf", 30)
    font = ImageFont.truetype("RADHAMUSIC/assets/thumb/font.ttf", 30)
    title_font = ImageFont.truetype("RADHAMUSIC/assets/thumb/font3.ttf", 45)
    ...
    play_icons = Image.open("RADHAMUSIC/assets/thumb/play_icons.png")
